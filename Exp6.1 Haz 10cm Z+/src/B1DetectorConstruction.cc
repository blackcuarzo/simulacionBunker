...
{  
  ...
  G4bool conPared = false;
  G4bool conFantoma1 = true;
  G4bool conFantoma2 = false;
...
// Pared Concreto
  ...
  G4double halfXPared = (3)*m; 
  G4double halfYPared = (3)*m; // La mitad de la verdadera altura
...
// Bunker
  ...
  G4double halfXCuboG = 5.*m,  halfYCuboG = (3 + 0.5)*m, halfZCuboG = 5*m; 
